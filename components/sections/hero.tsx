  ...
  return (
    <div className="relative flex h-screen items-center justify-center">
      <div className="min-h-screen w-screen overflow-hidden ">
        <div className="relative mt-40  h-96 w-screen overflow-hidden [mask-image:radial-gradient(50%_50%,white,transparent)] before:absolute before:inset-0 before:bg-[radial-gradient(circle_at_bottom_center,#d08274,transparent_90%)] before:opacity-100  after:absolute after:border-2 after:-left-1/2 after:top-1/2 after:aspect-[1/1.8] after:w-[200%] after:rounded-[50%] after:border-b after:border-[#a68163] after:bg-neutral-500">
        ...
        <article className=" pt-6 w-2/3 mx-auto block text-center z-10 relative text-neutral-600 ">
          <motion.h1
            initial={{ opacity: 0, y: 100 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 1, type: "tween" }}
            className="text-center text-7xl  font-extrabold  py-3 font-decorative "
          >
            Samara FEST
          </motion.h1>
          <motion.p
        ...
        <SponsorsSection />
        <div className="h-[500px] grid place-content-center text-neutral-100 font-decorative">
          <ScrollBaseAnimation
            delay={500}
            baseVelocity={-3}
